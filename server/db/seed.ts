...
const citiesData: CityNew[] = [
  { id: 1, name: 'Москва', countryId: 1, type: 'departure' },
  { id: 2, name: 'Санкт-Петербург', countryId: 1, type: 'departure' },
  { id: 3, name: 'Казань', countryId: 1, type: 'departure' },
  { id: 4, name: 'Уфа', countryId: 1, type: 'departure' },
  { id: 5, name: 'Нижний Новгород', countryId: 1, type: 'departure' },
  { id: 6, name: 'Самара', countryId: 1, type: 'departure' },
  { id: 7, name: 'Калининград', countryId: 1, type: 'departure' },
  { id: 8, name: 'Калуга', countryId: 1, type: 'departure' },
  { id: 10, name: 'Ярославль', countryId: 1, type: "departure" },
  { id: 11, name: 'Великий Новгород', countryId: 1, type: 'departure' },

  { id: 12, name: 'Анталия', countryId: 16, type: 'arrival' },
  { id: 13, name: 'Пхукет', countryId: 21, type: 'arrival' },
  { id: 14, name: 'Бали', countryId: 22, type: 'arrival' },
  { id: 15, name: 'Гагры', countryId: 23, type: 'arrival' },
  { id: 16, name: 'Ханой', countryId: 23, type: 'arrival' },
  { id: 17, name: 'Сочи', countryId: 23, type: 'arrival' },
  { id: 18, name: 'Анапа', countryId: 1, type: "arrival" },
  { id: 19, name: 'Дубаи', countryId: 1, type: 'arrival' },
  { id: 20, name: 'Хургада', countryId: 24, type: 'arrival' },
]
